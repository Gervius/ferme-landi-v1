                                    ...
                                    <tr key={index} className="group">
                                        <td className="px-6 py-3">
                                            <input
                                                ...
                                                className="w-full bg-transparent border-none focus:ring-0 text-sm font-semibold italic text-muted-foreground"
                                            />
                                        </td>
                                        ...
                                        <td className="px-4 py-3">
                                            <input
                                                ...
                                                className="w-full bg-muted/30 border border-border rounded px-2 py-1.5 text-sm font-black text-primary text-right focus:bg-background"
